<template>
  <div v-if="!isLoading && !noProducts" class="filterWrapper">
    <div class="filterIcon element-light-green" @click="showFilter">
      ...
      <div class="filter-inner">
        ...
        <div class="filter-property">
          <label class="checkbox-control">
            ...
            <input type="checkbox" v-model="stock" @change="updateStock" />
            <span class="checkbox-box"></span>
          </label>

          <label class="checkbox-control">
            <p class="filter-property--title">Товары Sale:</p>
            <input type="checkbox" v-model="sale" @change="updateSale" />
            <span class="checkbox-box"></span>
          </label>
        </div>
        ...
        <div class="clear-result__wrapper">
          <button
            ...
            class="clear-results__btn element-light-green"
          >
            Сбросить результаты
          </button>
        </div>
...
export default {
  ...
  methods: {
     ...
     */
    showFilter() {
      const divFilter = document.getElementsByClassName("filterWrapper")[0];

      let overlay = this.$root.$data.showOverlay();
