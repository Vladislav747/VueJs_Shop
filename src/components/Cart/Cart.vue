  ...
  <div v-else class="shopping-cart-items">
   <div class="shopping-cart__left">
    <div class="shopping-cart-title">
     ...
     <button
      class="btn-primary btn-clean-cart element-red-style"
      @click="deleteAllCart()"
     >
      Очистить корзину
     </button>
    ...
    <b-card-group class="cart-product-card">
     ...
     >
      <div class="product-top" @click="chooseItem(cart)">
       <div class="card-row">
      ...
      <button
       class="btn-primary element-red-style"
 ...
 methods: {
  ...
  chooseItem(item) {
   ...
   if (selectedElement) {
    ...
    let localOldSelected = JSON.parse(localStorage.getItem("selectedItems"));
